            ...
            <div class="row">
                <div class="col-md-4">
                    <section class="user_info">
                        <a href="#">
                            {!! Html::image(config('constants.path_image') . '/' . $user['avatar'], null, ['style' => 'height:80px; width:80px;', 'class' => 'gravatar'] ) !!}
                        </a>
                        <h3>{!! $user['name'] !!}</h3>
            ...
            @if(isset($user->following) && count($user->following))
                ...
                @foreach($user->following as $following)
                    <div class="col-md-5">
                        <section class="user_info">
                            <a href="#">
                                {!! Html::image(config('constants.path_image') . '/' . $following->follower_users['avatar'], null, ['style' => 'height:80px; width:80px;', 'class' => 'gravatar'] ) !!}
                            </a>
            ...
            @if(isset($user->follower) && count($user->follower))
                ...
                @foreach($user->follower as $follower)
                    <div class="col-md-5">
                        <section class="user_info">
                            <a href="#">
                                {!! Html::image(config('constants.path_image') . '/' . $follower->following_users['avatar'], null, ['style' => 'height:80px; width:80px;', 'class' => 'gravatar'] ) !!}
                            </a>
