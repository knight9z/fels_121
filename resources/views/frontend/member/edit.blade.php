                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-10 col-lg-offset-1">
                                ...
                                {!! Form::open(array('url' => 'client/member/' . $user->id, 'method' => 'PUT', 'enctype' => "multipart/form-data")) !!}
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('name', $user->name, array('class' => 'form-control', 'placeholder' => trans('frontend/member.edit.field.name'), 'autofocus' => true)) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::email('email', $user->email, array('class' => 'form-control', 'placeholder' => trans('frontend/member.edit.field.email'))) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::password('password', array('class' => 'form-control', 'placeholder' => trans('frontend/member.edit.field.password'))) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::password('password_repeat', array('class' => 'form-control', 'placeholder' => trans('frontend/member.edit.field.password_repeat'))) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::file('image', array('class' => 'form-control', 'placeholder' => trans('frontend/member.edit.field.image') )) !!}
                                        </div>
