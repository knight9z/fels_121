                        ...
                        <div class="dataTable_wrapper">
                            <table class="table table-striped  table-hover" >
                                ...
                                <tr>
                                    ...
                                    <th>{!! trans('backend/category/index.table.action') !!}</th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach($categories as $category)
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">
                                            ...
                                            <a href="javascript:elearning.confirm_delete('{{ url('./admin/delete/category/' . $category['id']) }}');" class="btn btn-danger btn-xs"><i title="Delete" class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
