                                ...
                                {!! Form::open(array('url' => 'admin/category/', 'method' => 'POST', 'enctype' => "multipart/form-data")) !!}
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('title', old('title'), array('class' => 'form-control', 'placeholder' => trans('backend/category.field.title'))) !!}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('summary', old('summary'), array('class' => 'form-control', 'placeholder' => trans('backend/category.field.summary'))) !!}
                                        </div>
