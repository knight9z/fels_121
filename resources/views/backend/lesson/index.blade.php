                            ...
                            <table class="table table-striped  table-hover" >
                                ...
                                @foreach($lessons as $lesson)
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">  {!! link_to('./admin/lesson/detail/list/' . $lesson['id'], trans('backend/lesson/index.button_list_word'), ['class' => 'btn btn-danger btn-xs', 'title' => 'List word for lesson']) !!}  </td>
                                        <td class="center"> {!! $lesson['count_words'] !!} </td>
                                        <td class="center">
                                            {!! link_to('./admin/lesson/detail/word/' . $lesson['id'], trans('backend/lesson/index.button_add_word'), ['class' => 'btn btn-success btn-xs', 'title' => 'Add word for lesson']) !!}
