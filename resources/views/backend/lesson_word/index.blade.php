                            ...
                            <table class="table table-striped  table-hover" >
                                ...
                                @foreach($words as $word)
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center"> {!! $word['words']['content'] !!} </td>
                                        <td class="center"> {!! $word['words']['answer']['locale']['content_answer'] !!} </td>
                                        <td class="center"> {!! $word['words']['answer']['locale']['note_answer'] !!} </td>
                                        <td class="center">
                                            {!! Form::open(array('url' => 'admin/lesson/detail/word/' . $word['id'] . '/' . $lesson->id, 'method' => 'DELETE')) !!}
